...
def main():
    ...
    if not args.skip_viz:
        ...
        print("model.classes_ =", builder.model.classes_)
        print("n_classes =", len(builder.model.classes_))
        print("feature_names数量 =", len(feature_names))
        print("模型特征数量 =", builder.model.n_features_in_)
        # 决策树静态可视化
